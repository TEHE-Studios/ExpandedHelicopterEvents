	...
	Events.OnCustomUIKey.Add(function(key)
		...
		if key == Keyboard.KEY_3 then
			...
			for k,v in pairs(getGameTime():getModData()["EventsSchedule"]) do
				print("------ "..k.." startDay:"..tostring(v.startDay).." startTime:"..tostring(v.startTime).." cutOff:"..tostring(v.cutOff)..
						" preset:"..tostring(v.preset).." renew:"..tostring(v.renew).." triggered:"..tostring(v.triggered))
			end
		end
	end)
