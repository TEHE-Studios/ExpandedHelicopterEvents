...
eHelicopter_PRESETS["military"] = {
	...
	markerColor = {r=0.21,g=0.47,b=0.09},
...
eHelicopter_PRESETS["military_attack_all"] = {
	inherit = {"military"},
	announcerVoice = false,
	markerColor = {r=0.7,g=0.21,b=0.03},
...
eHelicopter_PRESETS["news_chopper"] = {
	...
	forScheduling = true,
	markerColor = {r=0.74,g=0.58,b=0.17},
	eventStartDayFactor = 0.067,
...
eHelicopter_PRESETS["police"] = {
	...
	forScheduling = true,
	markerColor = {r=0.07,g=0.23,b=0.68},
	eventStartDayFactor = 0.067,
	eventCutOffDayFactor = 0.22,
...
eHelicopter_PRESETS["raiders"] = {
	...
	forScheduling = true,
	markerColor = {r=0.68,g=0.21,b=0.19},
	eventCutOffDayFactor = 1,
	eventStartDayFactor = 0.48,
