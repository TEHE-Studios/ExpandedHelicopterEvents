...
function announcerCore:chooseVoice(specificVoice)
	...
	self.announcerVoice = announcerCore.announcers[specificVoice]
end


---Announces random line if none is provided
---@param specificLine string
function announcerCore:announce(specificLine)
