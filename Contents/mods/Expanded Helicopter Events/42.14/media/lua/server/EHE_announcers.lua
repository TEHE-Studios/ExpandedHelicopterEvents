...
announcerCore:registerVoice("Raven Male",{
	["Lines"] = {
...
announcerCore:registerVoice("Gabby Female", {
	["Lines"] = {
...
announcerCore:registerVoice("Jade Male A",{
	["LineCount"] = 0,
	["Lines"] = {
...
announcerCore:registerVoice("Jade Male B", {
	["Lines"] = {
...
announcerCore:registerVoice("Jade Male C", {
	["Lines"] = {
...
announcerCore:registerVoice("FlyerChoppers", {
	["LeaveOutOfRandomSelection"] = true,
	["Lines"] = {
		["FlyerChoppers"] = {10500*2, "eHeli_lineM_11"},
	}})

announcerCore:registerVoice("Police", {
	["LeaveOutOfRandomSelection"] = true,
	["Lines"] = {
