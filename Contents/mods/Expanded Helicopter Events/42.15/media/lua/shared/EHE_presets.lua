...
eHelicopter_PRESETS["military_nonhostile"] = {
	...
	eventSpawnWeight = {30, 0.85, 5},
	schedulingFactor = {2.0, 0.2, 1.5},
	attackDelay = 5,
	attackSpread = 5,
	attackSplash = 2,
	attackHitChance = 70,
...
eHelicopter_PRESETS["drones"] = {
	...
	callsigns = {"Eye", "Shadow", "Watchdog", "Sentinel", "Ghost", "Phantom", "Specter"},
	presetProgression = {
...
eHelicopter_PRESETS["deserters"] = {
	...
	crew = {
		{ outfit = "Shark_Brigand_Pilot_1993", female = 0 },
		{ outfit = "Shark_Brigand_Assaulter_1993", female = 0 },
		{ outfit = "Shark_Brigand_Assaulter_1993", female = 0 },
		{ outfit = "Shark_Brigand_Assaulter_1993", female = 0 },
		{ outfit = "Shark_Brigand_Assaulter_1993", spawn = 75, female = 0 },
	},
	forScheduling = true,
